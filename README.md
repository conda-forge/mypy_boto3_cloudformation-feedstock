About mypy_boto3_cloudformation
===============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mypy_boto3_cloudformation-feedstock/blob/master/LICENSE.txt)

Summary: Type annotations for boto3.CloudFormation 1.17.73 service, generated by mypy-boto3-buider 4.13.1
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12747&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mypy_boto3_cloudformation-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mypy_boto3_cloudformation` can be installed with:

```
conda install mypy_boto3_cloudformation
```

It is possible to list all of the versions of `mypy_boto3_cloudformation` available on your platform with:
